...
const columns: GridColDef[] = [
  ...
  },
  {
    ...
    return params.value && typeof params.value === 'object' ? 
        (params.value.username || "Unknown") : "Unknown";
    }
  ...
  },
  {
    ...
    renderCell: (params) => {
    return params.value && typeof params.value === 'object' ? 
      (params.value.username || "Unassigned") : "Unassigned";
    }
  },
];
...
const ReusablePriorityPage = ({ priority }: Props) => {
  ...
  const userId = 1;
  const { data: tasks, isLoading, isError: isTaskError } = useGetTasksByUserQuery(1, {
    skip: userId === null
  });
